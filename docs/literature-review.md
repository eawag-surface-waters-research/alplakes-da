...
**takeaway: big improvements in NWP representation of laks through assimilation in simple 1D model where large biases are known using a non-ensemble method to integrate in situ and satellite data. Perturbation of states.**
