...
Both expose a ``run_*(run_raw, ensemble_raw, ensemble_base, n_members)`` driver that
builds args, runs the daily loop, and writes the posterior summary to final_output/.
