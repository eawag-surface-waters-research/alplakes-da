...
openda_adapter (from the warmup snapshot's full-grid T profile).
...
\t<!-- GENERATED by src/openda_config.py (filter={filter}). Do not edit by hand;
\t     change the FILTERS spec / templates in openda_config.py instead. -->
...
_PARALLEL = """<threadConfigstoch>
    <!-- GENERATED by src/openda_config.py. maxThreads = n_members + 1 (main + ensemble). -->
...
\t<!-- GENERATED by src/openda_config.py. -->
...
\t<!-- GENERATED by src/openda_config.py (filter={filter}). -->
...
<timeSeriesFormatterConfig xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <!-- GENERATED by src/openda_config.py. time column = Simstrat days (since 1 Jan {ref_year}).
...
---
# GENERATED by src/openda_config.py. Time in Simstrat days (days since 1 Jan {ref_year}).
