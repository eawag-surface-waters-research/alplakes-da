...
# Canonical source of static/lakes.geojson — refresh the bundled file from here
# if a lake polygon ever changes. The pipeline reads the bundled copy, not this.
